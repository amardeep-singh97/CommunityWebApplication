  ...
  <header class="text-gray-600 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      <nav class=" md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400 flex flex-wrap items-center text-base justify-center">
        ...
        <router-link  class="mr-5 hover:text-gray-900 cursor-pointer" class-active="active" to="/restaurant/scan-qr-code" exact>Scan QR Code</router-link>
         <router-link  class="mr-5 hover:text-gray-900 cursor-pointer" class-active="active" to="/restaurant/food-items" exact>Food Items</router-link>
          <router-link  class="mr-5 hover:text-gray-900 cursor-pointer" class-active="active" to="/food-item/create" exact>Add item</router-link>
...
<!--        <router-link tag="li" class="mr-5 hover:text-gray-900 cursor-pointer" class-active="active" to="/list" exact>Restaurant List</router-link>-->
      ...
      <!-- <router-link to="/sign-up" v-if="user_type !== 'restaurant' && user_type !== 'customer'">
        ...
        <!-- <button  v-on:click="ClearCookies" class="inline-flex text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-lg" stroke-linecap="round" stroke-linejoin="round">
         ...
         <router-link to ="/"> 
         <button  v-on:click="ClearCookies" class="inline-flex text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-lg" >
          Sign out
           <svg fill="none"  class="w-4 h-4 ml-1" viewBox="0 0 24 24" >
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
